...
namespace ChessTests
{
    public class AlgebraicNotationTests
    {
        ...
        public void IdenticalRookActions_SameFile_RankResolution()
        {
            ...
            // actions AN should be equal before resolution
            Assert.Equal(lowRookAction.AlgebraicNotation, highRookAction.AlgebraicNotation);

            AlgebraicNotationUtils.AlgebraicNotationAmbiguityResolution(ambiguousActions);

            Assert.NotEqual(lowRookAction.AlgebraicNotation, highRookAction.AlgebraicNotation);
        ...
        public void IdentialRookActions_SameRank_FileResolution()
        {
            ...
            Assert.Equal(leftRookAction.AlgebraicNotation, rightRookAction.AlgebraicNotation);

            AlgebraicNotationUtils.AlgebraicNotationAmbiguityResolution(ambiguousActions);

            Assert.NotEqual(leftRookAction.AlgebraicNotation, rightRookAction.AlgebraicNotation);
        ...
        public void IdenticalBishopActions_SameRank_FileResolution()
        {
            ...
            Assert.Equal(leftBishopAction.AlgebraicNotation, rightBishopAction.AlgebraicNotation);

            AlgebraicNotationUtils.AlgebraicNotationAmbiguityResolution(ambiguousActions);

            Assert.NotEqual(leftBishopAction.AlgebraicNotation, rightBishopAction.AlgebraicNotation);
        ...
        public void IdenticalKnightActions_SameFile_RankResolution()
        {
            ...
            Assert.Equal(topKnightAction.AlgebraicNotation, bottomKnightAction.AlgebraicNotation);

            AlgebraicNotationUtils.AlgebraicNotationAmbiguityResolution(ambiguousActions);

            Assert.NotEqual(topKnightAction.AlgebraicNotation, bottomKnightAction.AlgebraicNotation);
